...
function SignUp() {
  return (
    <section>
      <div class="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-14">
        <div class="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <p class="mt-2 text-center text-base text-gray-600">
            ...
            <NavLink
              to="/logins"
              className="font-medium  text-md px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none"
            >
              SignIn
            </NavLink>
          </p>
